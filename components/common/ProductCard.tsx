...
export default function ProductCard({ product }: { product: Product }) {
    return (
        <div className="flex flex-col items-center text-center p-3 border border-[#CCCCCC] bg-white rounded-[33px] w-full h-full max-lg:w-[240px] lg:max-w-[370px] shadow-[0px_4px_4px_0px_rgba(170,170,170,0.25)]" >
