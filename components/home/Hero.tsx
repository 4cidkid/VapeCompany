...
export default function HeroSection() {
    ...
    return (
        <>
            <section className="w-full h-[650px] bg-no-repeat bg-right bg-cover max-sm:bg-center max-sm:bg-[url('https://cdn.nicotordev.com/files/7c32ac19-e9e3-4852-a14b-4aca25d57e9a.webp')] max-lg:bg-[url('https://cdn.nicotordev.com/files/8e16a671-4a6a-4293-9b3b-10d5a221929b.webp')] bg-[url('https://cdn.nicotordev.com/files/80a2adb6-6318-4b95-a5f3-e0038d3d08d8.webp')]">
