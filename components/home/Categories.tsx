...
export default function Categories({ categories }: CategoriesProps) {
    ...
    return (
        <div>
            <div className="max-lg:pt-12 max-xl:px-12 mx-auto flex items-center flex-wrap child:flex-grow child:min-w-[300px] justify-center max-w-7xl child:basis-[calc(50%-2rem)] child:relative child:h-72 gap-[2rem]">
                {
